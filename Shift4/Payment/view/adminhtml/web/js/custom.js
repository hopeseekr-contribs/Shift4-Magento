jQuery(document).ready(
    function () {
        ...
        jQuery('select[id*="shift4_section_processing_mode"]').change(
            function () {
                changeProcessingMode(this.value);
            }
        );
    
        jQuery('#access_token_unmask').click(
            function () {
        ...
        jQuery('#shift4_cancel_token_exchange').click(
            function () {
        ...
        jQuery('#shift4_exchange_tokens').click(
            function () {
