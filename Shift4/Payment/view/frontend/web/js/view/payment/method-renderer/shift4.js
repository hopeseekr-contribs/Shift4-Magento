        ...
        return Component.extend(
            {
                ...
                initialize: function () {
                    ...
                    self.i4goInitialized = setInterval(
                        function () {
                             self.loadi4go();
                        }, 100
                    );
                ...
                loadi4go: function () {
                    ...
                    if ($('#i4go_form') && $('#i4go_form').length > 0) {
                        ...
                        $.each(
                            window.checkoutConfig.payment.shift4_custom_data.partial_payments, function (key, value) {
                                var partial = [
